...
Mario.Character.prototype.Move = function() {
    ...
    var sideWaysSpeed = Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Space) ? 1.2 : 0.6;
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Space) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
    ...
    this.CanShoot = !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Space);
...
Mario.Character.prototype.Stomp = function(object) {
    ...
    if (object instanceof Mario.Enemy || object instanceof Mario.BulletBill) {
        ...
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Space) && object.Facing === 0) {
            this.Carried = object;
            object.Carried = true;
        } else {
            Enjine.Resources.PlaySound("kick");
